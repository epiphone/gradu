...
[Wagner, Brandon, and Arun Sood. "Economics of Resilient Cloud Services." (2016)](http://ieeexplore.ieee.org/abstract/document/7573771/)
We cannot avoid failures or successful attacks all of the time, thus our push is to design resilient and secure systems in tandem. This presents a big challenge in the dynamic cloud ecosystem. [...] managed code execution services such as AWS Lambda and GCP’s Google Cloud Functions can significantly **reduce the cost of operating a resilient system** even in comparison to spot and preemptible VMs.
