...
\textbf{Problem:} How to execute operations that exceed serverless resource limits?
...
A function distributes task among parallel worker functions. Workers can optionally "fan in" to a persistence layer where result is further aggregated

Composed Message Processor or Aggregator in \textcite{hohpe2004enterprise}.
workaround over 15 minute limit
