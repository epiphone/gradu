...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{patterns/function-chain.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{patterns/polling-event-processor.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{patterns/throttler.png}
  \caption{Throttler}
  \label{fig:throttler}
\end{figure}
