...
\textbf{Problem:} How to execute a piece of code on-demand as a result of an event occurrence?
...
\textbf{Solution:} Subscribe a serverless function to a cloud event source.

The pattern minimizes costs by invoking functions only when events occur, and enables scalability by automatically invoking functions based on the number of events \parencite{hong18securingviaserverlesspatterns}.
