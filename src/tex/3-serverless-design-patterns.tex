...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\textwidth]{patterns/state-machine.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{patterns/strangler.png}
  \caption{Strangler}
  \label{fig:strangler}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{patterns/function-warmer.png}
