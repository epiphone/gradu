...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.3\textwidth]{patterns/routing-function.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{patterns/event-processor.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.35\textwidth]{patterns/periodic-invocation.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\textwidth]{patterns/polling-event-processor.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\textwidth]{patterns/event-broadcast.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{patterns/strangler.png}
  \caption{Strangler}
  \label{fig:strangler}
\end{figure}
...
% TODO benefits of granular scaling
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.65\textwidth]{patterns/throttler.png}
  \caption{Throttler}
  \label{fig:throttler}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.73\textwidth]{patterns/circuit-breaker.png}
