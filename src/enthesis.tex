...
execution/invocation models, input, context, meta (env variables, auth role, ...), output...
not quite devoid of operational management: time limit, memory size, although automated approaches exist

\textcite{reza17controller} present a QoS-aware resource allocation controller for FaaS

function input/output...

event sources...

function workflow/use cases...

platform also supports versioning, monitoring/statistics, RPC invoke...
